        ...
        <div className="list-books-content">
          <div>
            <BookCategory
              ...
              books={bookList.filter((book) => book.category === 'current')}
            />
            <BookCategory
              category='Want to Read'
              books={bookList.filter((book) => book.category === 'want')}
            />    
            <BookCategory
              category='Read'
              books={bookList.filter((book) => book.category === 'read')}
            />                      
          </div>
        </div>
        <div className="open-search">
          <a onClick={this.props.onAddClick}>Add a book</a>
        </div>
      </div>
    )
  }
